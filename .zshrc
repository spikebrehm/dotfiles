...
# (disable here, to use "Pure", installed separately)
ZSH_THEME=""
...
# BELOW HERE IS OLD .bash_profile STUFF
...
function gfo() { git fetch origin "$1" && git checkout "$1"; }
alias grom='git pull --rebase origin master'
alias gcob='git checkout -b'
alias gref='git rev-parse HEAD'
alias gaddw='git diff -w --no-color | git apply --cached'
